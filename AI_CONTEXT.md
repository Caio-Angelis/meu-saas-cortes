...
| Smart crop | `SMART_CROP_ENABLED`, `SMART_CROP_FRAME_SAMPLES`, `SMART_CROP_SPEAKER_FPS`, `SMART_CROP_MIN_CHANGE_INTERVAL_SEC`, `SMART_CROP_MEDIAPIPE_GPU`, `SMART_CROP_MEDIAPIPE_GPU_FORCE`, `SMART_CROP_SPLIT_ENABLED` (flag 6B; default ligado), `BLAZEFACE_TFLITE_SHA256` (opcional) |
